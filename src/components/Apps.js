...
function Dictionary() {
    ...
    return (
        <Paper sx={{ height: "30vh" }}>
            <Typography variant="h5">Dictionary app
            </Typography>
            <Box sx={{ pt: 5, mb: 3 }}>
                <TextField
                ...
                <Button id="btne" onClick={handleFetch} variant="outlined" >Get word</Button>
            </Box>

            {fetchCompleted && errorMessage === '' && (
                <Card sx={{ border: "1px black solid", pt: 2, pb: 2, pl: 2, textAlign: "left" }}>
